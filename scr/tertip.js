...
function cesitler() {$(".sak").hide();
                    ...
                    $("#cerceveOrta").append(document.getElementById("urunler"));}
function home() {$("#yedek").append(document.getElementById("baslik"));
                 $("#yedek").append(document.getElementById("urunler"));
                 $(".sak").show();}